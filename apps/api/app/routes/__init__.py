...
from apps.api.app.routes.automation import router as automation_router
...
from apps.api.app.routes.internal_mt5 import router as internal_mt5_router
...
from apps.api.app.routes.trade_plans import router as trade_plans_router
from apps.api.app.routes.trade_proposals import router as trade_proposals_router

api_router = APIRouter(prefix="/api/v1")
api_router.include_router(auth_router)
api_router.include_router(internal_mt5_router)
...
api_router.include_router(knowledge_assistant_router)
