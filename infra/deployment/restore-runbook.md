...
3. Run `alembic current`, verify migration `0009`, extension availability, row counts, ownership constraints, outbox continuity, and audit hashes.
...
6. Exercise fixture risk, approval, reconciliation, journal, credential destruction, and backup recovery probes.
