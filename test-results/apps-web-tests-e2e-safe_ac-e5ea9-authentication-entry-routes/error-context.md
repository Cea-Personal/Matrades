...
- Name: apps/web/tests/e2e/safe_account.spec.ts >> unauthenticated visitors see the TraderX authentication entry routes
- Location: apps/web/tests/e2e/safe_account.spec.ts:3:5
