...
- Name: apps/web/tests/e2e/accessibility.spec.ts >> primary controls meet contrast and failures expose an accessible recovery message
- Location: apps/web/tests/e2e/accessibility.spec.ts:31:5
