...
- Name: apps/web/tests/e2e/accessibility.spec.ts >> market automation exposes labelled controls and non-colour evidence states
- Location: apps/web/tests/e2e/accessibility.spec.ts:58:5
